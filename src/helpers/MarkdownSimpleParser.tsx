// COPIED FROM SLIMDOWN.JS 
// ORIGINAL CODE BY rikvullings
// @ https://github.com/erikvullings/slimdown-js/blob/master/src/index.ts
        ...
        ? externalLinks
            ? removeImages
                ...
                : markdown
                    ...
                    .replace(/<a href="/s, '<a target="_blank" href="')
            : removeImages
                ? markdown.trim().replace(/<p>(.*)<\/p>$/mgs, '$1')
                    .replace(/<img src="(.*?)\>$/mgs, '\n')
                : markdown.trim().replace(/<p>(.*)<\/p>$/mgs, '$1')
        : externalLinks
            ? removeImages
